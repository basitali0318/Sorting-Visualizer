...
void intro()
{
    cout<<"==============================Sorting Visualizer======/========================\n\n"
        ...
        <<"The sorting algorithms covered here are Selection Sort, Insertion Sort, Bubble Sort, Merge Sort, Quick Sort Heap Sort and Shell Sort.\n"
...
int main(int argc, char* args[])
{
    ...
    while(1)
    {
        ...
        if(controls())
        {
            if(!execute()) // if execute returns false, break the loop
                break;
        }
        else
        {
